...
import { Github, ExternalLink, X, Code, ShoppingBag, BarChart3, ChevronDown, Heart } from 'lucide-react';
...
const ProjetosSection = () => {
  ...
  const projects = [
    ...
    },
    {
      id: 4,
      title: "Amor Eterno",
      description: "Um site romântico feito em React + Vite + Tailwind, com animações suaves usando Framer Motion e AOS. Criado para demonstrar criatividade, tecnologia e principalmente amor em forma digital.",  
      icon: Heart,
      link: "https://amor-eterno-five.vercel.app",
      githubLink: "https://github.com/JaoPred0/Amor-Eterno",
      imageUrl: "/amor-eterno.png"
    },
    // {  
    //   id: 5,  
    //   title: "FitTrackr",  
